#!/usr/bin/env python
# -*- coding: utf-8 -*-
from create_twlda_datasets_10 import *
...
if __name__ == '__main__':
    ...
    for uid, f1 in f1s:
        ...
        # try:
        #     comb_clf = load_model_small(uid, 'svc', 'combtwlda', n_topics=10)
        # except Exception as e:
        #     comb_clf = model_select_svc2(ds_comb, n_jobs=5)
        #     save_model_small(comb_clf, uid, 'svc', 'combtwlda', n_topics=10)

        comb_clf = model_select_svc2(ds_comb, n_jobs=5)
        save_model_small(comb_clf, uid, 'svc', 'combtwlda_unscaled', n_topics=10)
